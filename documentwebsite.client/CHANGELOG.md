...
- Create Angular project with ng: `ng new documentwebsite.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`documentwebsite.client.esproj`).
